...
namespace Assets.Scripts.Interoplations.Helpers.Animation
{
    static public class Easings
    {
        ...
        /// <summary>
        /// InterpolateE using the specified function.
        /// </summary>
        static public float InterpolateE(float p, Functions function)
        {
            switch (function)
            {
                default:
        ...
        static public Function GetInterpolator(Functions function)
        {
            switch (function)
            {
                default:
                case Functions.Linear: return Linear;
                case Functions.QuadraticEaseOut: return QuadraticEaseOut;
                case Functions.QuadraticEaseIn: return QuadraticEaseIn;
                case Functions.QuadraticEaseInOut: return QuadraticEaseInOut;
                case Functions.CubicEaseIn: return CubicEaseIn;
                case Functions.CubicEaseOut: return CubicEaseOut;
                case Functions.CubicEaseInOut: return CubicEaseInOut;
                case Functions.QuarticEaseIn: return QuarticEaseIn;
                case Functions.QuarticEaseOut: return QuarticEaseOut;
                case Functions.QuarticEaseInOut: return QuarticEaseInOut;
                case Functions.QuinticEaseIn: return QuinticEaseIn;
                case Functions.QuinticEaseOut: return QuinticEaseOut;
                case Functions.QuinticEaseInOut: return QuinticEaseInOut;
                case Functions.SineEaseIn: return SineEaseIn;
                case Functions.SineEaseOut: return SineEaseOut;
                case Functions.SineEaseInOut: return SineEaseInOut;
                case Functions.CircularEaseIn: return CircularEaseIn;
                case Functions.CircularEaseOut: return CircularEaseOut;
                case Functions.CircularEaseInOut: return CircularEaseInOut;
                case Functions.ExponentialEaseIn: return ExponentialEaseIn;
                case Functions.ExponentialEaseOut: return ExponentialEaseOut;
                case Functions.ExponentialEaseInOut: return ExponentialEaseInOut;
                case Functions.ElasticEaseIn: return ElasticEaseIn;
                case Functions.ElasticEaseOut: return ElasticEaseOut;
                case Functions.ElasticEaseInOut: return ElasticEaseInOut;
                case Functions.BackEaseIn: return BackEaseIn;
                case Functions.BackEaseOut: return BackEaseOut;
                case Functions.BackEaseInOut: return BackEaseInOut;
                case Functions.BounceEaseIn: return BounceEaseIn;
                case Functions.BounceEaseOut: return BounceEaseOut;
                case Functions.BounceEaseInOut: return BounceEaseInOut;
            }
        }
        ...
        static public float BounceEaseOut(float p)
        {
            ...
            {
                return 1;//(54/5.0f * p * p) - (513/25.0f * p) + 268/25.0f;
            }
        }
